            ...
            return (
              ...
              >
                <div className="flex flex-col items-center gap-4 mb-6">
                  <motion.div
                    className="w-16 h-16 rounded-full bg-white/10 flex items-center justify-center flex-shrink-0"
                    variants={{
                  ...
                  <p className="text-sm text-white/50 uppercase tracking-wide font-body font-medium">
                    {notice.date}
                  </p>
                </div>
                <h3 className="text-3xl text-white mb-4 font-body font-medium">
                  {notice.title}
                </h3>
                <p className="text-lg text-white/70 leading-relaxed font-body font-medium max-w-2xl mx-auto">
                  {notice.description}
                </p>
