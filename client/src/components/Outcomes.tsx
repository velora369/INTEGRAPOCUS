...
export function Outcomes() {
  const outcomes = [
    ...
    },
    {
      ...
      title: 'Casos clínicos & simulação',
      description: 'Cenários reais passo a passo para treinar raciocínio diagnóstico com POCUS: do achado à conduta. Simulações rápidas com feedback para fixar protocolo e decisão.'
    }
  ];
