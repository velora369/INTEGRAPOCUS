...
## Recent Changes
- **November 25, 2025**: Updated Hero section vacancy animation to reflect sale of additional spots - now transitions from 9 to 3 vagas after 3 seconds (previously was 5 vagas). The animation shows 9 vagas initially, then transitions directly to 3 after 3 seconds with the red pulsing effect for urgency. The accessible tooltip and keyboard navigation remain functional.
- **November 16, 2025**: Updated Hero section vacancy animation to reflect sale of another spot - now transitions from 9 to 5 vagas after 3 seconds (previously was 6 vagas). The animation shows 9 vagas initially, then transitions directly to 5 after 3 seconds with the red pulsing effect for urgency. The accessible tooltip and keyboard navigation remain functional.
- **November 6, 2025**: Simplified Hero section vacancy animation to transition directly from 9 to 6 vagas after 3 seconds, removing the intermediate 8 vagas step. The animation now shows 9 vagas initially, then transitions directly to 6 after 3 seconds with the red pulsing effect for urgency. The accessible tooltip and keyboard navigation remain functional.
